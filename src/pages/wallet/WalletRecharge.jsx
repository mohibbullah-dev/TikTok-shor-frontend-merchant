  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-32">
      ...
      {isUSDT ? (
        <>
          ...
          <div className="mx-4 mt-4 bg-white rounded-2xl p-5 shadow-sm">
            <div className="flex items-center gap-2 mb-4">
              ...
              <p className="text-gray-700 font-bold">USDT - TRC20 Network</p>
            </div>

            {/* QR Code placeholder */}
            <div
              className="w-40 h-40 mx-auto bg-gray-100 rounded-2xl
            ...
            <div className="bg-gray-50 rounded-xl p-3 mb-3">
              ...
              <p
                className="text-gray-700 text-xs font-mono break-all
                leading-relaxed"
              >
                {USDT_ADDRESS}
              </p>
          ...
          {/* Warning */}
          <div
            className="mx-4 mt-3 p-3 bg-red-50 rounded-xl
        ...
        // Bank Transfer Info
        <div className="mx-4 mt-4 bg-white rounded-2xl p-5 shadow-sm">
          <p className="text-gray-700 font-bold mb-4">Bank Transfer Details</p>
          {[
      ...
      <div className="mx-4 mt-4 bg-white rounded-2xl p-4 shadow-sm">
        ...
        {voucher ? (
          ...
          <label className="block cursor-pointer">
            <div
              className="h-36 border-2 border-dashed border-gray-200
